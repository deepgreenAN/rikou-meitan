...
pub async fn save_movie_clip(cmd: SaveMovieClipCommand) -> Result<(), AppCommonError> {
...
pub async fn edit_movie_clip(cmd: EditMovieClipCommand) -> Result<(), AppCommonError> {
...
pub async fn all_movie_clips(_cmd: AllMovieClipCommand) -> Result<Vec<MovieClip>, AppCommonError> {
...
pub async fn remove_movie_clip(cmd: RemoveMovieClipCommand) -> Result<(), AppCommonError> {
